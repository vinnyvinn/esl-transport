...
class BillOfLanding extends Model
{
    protected  $fillable = ['vessel_id','time_allowed','code_name','voyage_id','quote_id',
        'Client_id','cargo_id','place_of_receipt','date_of_loading','laytime_start',
        'berth_number','seal_number','number_of_crane','sof_status','status','discharge_rate','bl_number','stage'];
