                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="home" role="tabpanel">
                                            <div class="p-20">
                                                <form class="form-material m-t-40" onsubmit="event.preventDefault();submitForm(this, '/others-vessel-details','redirect');" action="" id="vessel">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="country_of_loading" required id="country_of_loading"
                                                                        class="select2 form-control">
                                                                    <option value="">Select Country</option>
                                                                    @foreach(\Esl\helpers\Constants::COUNTRY_LIST as $value)
                                                                        <option value="{{$value}}">{{$value}}</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="loa" name="loa" class="form-control" placeholder="Length Over All">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="grt">Gross Tonnage  GRT</label>
                                                                <input type="text" id="grt" name="grt" class="form-control" placeholder="Gross Tonnage ">
                                                            </div>
                                                            <div class="form-group">
